...
final class X25519XChaCha20Poly1305Test extends TestCase
{
    ...
    public function authenticatedEncryptionRegressionTest(): void
    {
        ...
        $ciphertext = CipherText::import(File::read(__DIR__ . '/../../Fixtures/lorem_x25519xchacha20poly1305.txt'));
    ...
    public function anonymousEncryptionRegressionTest(): void
    {
        ...
        $ciphertext = CipherText::import(File::read(__DIR__ . '/../../Fixtures/lorem_x25519xchacha20poly1305_anonymous.txt'));
