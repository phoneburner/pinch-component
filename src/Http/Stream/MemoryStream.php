...
/**
 * StreamInterface optimized for a stream kept completely within memory. Unlike
 * the TempStream, this stream is not written to a temporary file if the data
 * gets too large. Caution is advised when using this stream with data of unknown
 * or arbitrary size.
 */
class MemoryStream implements \Stringable, StreamInterface
{
    ...
    public static function copy(StreamInterface $stream, bool $rewind_original = true): self
    {
