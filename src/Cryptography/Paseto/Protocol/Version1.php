 ...
 */
final class Version1 implements PasetoProtocol
{
    public const PasetoVersion VERSION = PasetoVersion::V1;
    public const string HEADER_PUBLIC = PasetoVersion::V1->value . '.public.';
    public const string HEADER_LOCAL = PasetoVersion::V1->value . '.local.';
